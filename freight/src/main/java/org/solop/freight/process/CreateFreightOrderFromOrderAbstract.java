 ...
 */
public abstract class CreateFreightOrderFromOrderAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SOLOP_SBP_CreateFreightOrderFromOrder";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Create Freight Order From Order";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54706;

 ...
 */
public abstract class CreateFreightOrderFromDistributionOrderAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SOLOP_SBP_CreateFreightOrderFromDDOrder";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Create Freight Order From Distribution Order";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54707;

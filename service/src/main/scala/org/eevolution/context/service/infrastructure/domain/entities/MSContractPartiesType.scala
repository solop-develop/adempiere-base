...
import org.adempiere.core.domains.models.X_S_ContractPartiesType

import java.sql.ResultSet
import java.util.{Comparator, Properties}


class MSContractPartiesType(
  ctx:     Properties,
  id:      Int,
  rs:      ResultSet,
  trxName: String)
    extends X_S_ContractPartiesType(ctx: Properties, id: Int, trxName: String) {

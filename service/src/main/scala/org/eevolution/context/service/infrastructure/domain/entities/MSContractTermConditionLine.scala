...
import org.adempiere.core.domains.models.X_S_ContractTermConditionLine

import java.sql.ResultSet
import java.util.{Comparator, Properties}

class MSContractTermConditionLine(
  ctx:     Properties,
  id:      Int,
  rs:      ResultSet,
  trxName: String)
    extends X_S_ContractTermConditionLine(ctx: Properties, id: Int, trxName: String) {

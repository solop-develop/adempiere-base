...
public class X_S_ContractLine extends org.compiere.model.PO implements I_S_ContractLine, org.compiere.model.I_Persistent 
{
...
// 0
    ...
    {
		return (I_C_ProjectPhase) org.compiere.model.MTable.get(getCtx(), I_C_ProjectPhase.Table_Name)
    ...
    {
		return (I_C_ProjectTask) org.compiere.model.MTable.get(getCtx(), I_C_ProjectTask.Table_Name)
    ...
    {
		return (I_C_ServiceLevel) org.compiere.model.MTable.get(getCtx(), I_C_ServiceLevel.Table_Name)
    ...
    {
		return (I_C_Tax) org.compiere.model.MTable.get(getCtx(), I_C_Tax.Table_Name)
    ...
    {
		return (I_C_UOM) org.compiere.model.MTable.get(getCtx(), I_C_UOM.Table_Name)
	...
	public org.adempiere.core.domains.models.I_S_ContractLine getLink_ContractLine() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_S_ContractLine) org.compiere.model.MTable.get(getCtx(), Table_Name)
	...
	public org.adempiere.core.domains.models.I_M_AttributeSetInstance getM_AttributeSetInstance() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_M_AttributeSetInstance) org.compiere.model.MTable.get(getCtx(), org.adempiere.core.domains.models.I_M_AttributeSetInstance.Table_Name)
    ...
    {
		return (I_M_Product) org.compiere.model.MTable.get(getCtx(), I_M_Product.Table_Name)
    ...
    {
		return (I_M_Promotion) org.compiere.model.MTable.get(getCtx(), I_M_Promotion.Table_Name)
    ...
    {
		return (I_PP_Period) org.compiere.model.MTable.get(getCtx(), I_PP_Period.Table_Name)
	...
	public org.adempiere.core.domains.models.I_S_ContractLine getRef_ContractLine() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_S_ContractLine) org.compiere.model.MTable.get(getCtx(), Table_Name)
	...
	public I_R_StandardRequestType getR_StandardRequestType() throws RuntimeException
    {
		return (I_R_StandardRequestType) org.compiere.model.MTable.get(getCtx(), I_R_StandardRequestType.Table_Name)
	...
	public org.adempiere.core.domains.models.I_S_ServiceType getS_ServiceType() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_S_ServiceType) org.compiere.model.MTable.get(getCtx(), org.adempiere.core.domains.models.I_S_ServiceType.Table_Name)

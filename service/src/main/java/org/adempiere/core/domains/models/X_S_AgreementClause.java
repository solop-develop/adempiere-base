...
public class X_S_AgreementClause extends PO implements I_S_AgreementClause, I_Persistent 
{
	...
	public org.adempiere.core.domains.models.I_S_AgreementClauseCategory getS_AgreementClauseCategory() throws RuntimeException
    {
		return (org.adempiere.core.domains.models.I_S_AgreementClauseCategory)MTable.get(getCtx(), org.adempiere.core.domains.models.I_S_AgreementClauseCategory.Table_Name)

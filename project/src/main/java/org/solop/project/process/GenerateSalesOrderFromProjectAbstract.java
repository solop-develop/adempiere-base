 ...
 */
public abstract class GenerateSalesOrderFromProjectAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_Project_GenerateSalesOrder";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Generate Sales Order (From Project)";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54792;

...
(C_PAYMENT_ID, AD_CLIENT_ID, AD_ORG_ID, ISACTIVE, CREATED, 
 ...
 C_BP_AccountType_ID, C_BP_SalesGroup_ID, C_BP_Segment_ID, C_BP_IndustryType_ID, CollectingAgent_ID, C_Card_ID, C_CardProvider_ID, A_Country, AD_OrgTrx_ID, BusinessPartnerForRefund_ID, C_Bank_ID, C_CashBook_ID, ChargeAmt,

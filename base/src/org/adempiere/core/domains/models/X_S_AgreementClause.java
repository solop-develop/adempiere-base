...
public class X_S_AgreementClause extends PO implements I_S_AgreementClause, I_Persistent 
{
	...
	public I_S_AgreementClauseCategory getS_AgreementClauseCategory() throws RuntimeException
    {
		return (I_S_AgreementClauseCategory)MTable.get(getCtx(), I_S_AgreementClauseCategory.Table_Name)
    ...
    {
		return (I_S_AgreementType)MTable.get(getCtx(), I_S_AgreementType.Table_Name)

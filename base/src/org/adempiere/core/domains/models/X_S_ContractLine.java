...
// 0
	...
	public I_S_ContractLine getLink_ContractLine() throws RuntimeException
    {
		return (I_S_ContractLine) org.compiere.model.MTable.get(getCtx(), Table_Name)
    ...
    {
		return (I_M_AttributeSetInstance) org.compiere.model.MTable.get(getCtx(), I_M_AttributeSetInstance.Table_Name)
	...
	public I_S_ContractLine getRef_ContractLine() throws RuntimeException
    {
		return (I_S_ContractLine) org.compiere.model.MTable.get(getCtx(), Table_Name)
    ...
    {
		return (I_S_Contract) org.compiere.model.MTable.get(getCtx(), I_S_Contract.Table_Name)
    ...
    {
		return (I_S_ServiceType) org.compiere.model.MTable.get(getCtx(), I_S_ServiceType.Table_Name)

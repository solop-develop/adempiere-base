...
/** Generated Model for C_Card
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4 - $Id$ */
public class X_C_Card extends PO implements I_C_Card, I_Persistent 
{
    ...
    public X_C_Card (Properties ctx, int C_Card_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_C_Card (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_Card[")
	...
	{
		if (C_Card_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_Card_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_Card_ID, Integer.valueOf(C_Card_ID));
	}

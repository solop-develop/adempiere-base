...
/** Generated Model for AD_TagType
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4 - $Id$ */
public class X_AD_TagType extends PO implements I_AD_TagType, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20260604L;

    /** Standard Constructor */
    public X_AD_TagType (Properties ctx, int AD_TagType_ID, String trxName)
    {
      super (ctx, AD_TagType_ID, trxName);
      /** if (AD_TagType_ID == 0)
        {
			setAD_Column_ID (0);
			setAD_Table_ID (0);
    ...
    /** Load Constructor */
    public X_AD_TagType (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_TagType[")
	...
	/** Set Tag Type.
		...
		Tag Type
	  */
	public void setAD_TagType_ID (int AD_TagType_ID)
	{
		if (AD_TagType_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_AD_TagType_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_AD_TagType_ID, Integer.valueOf(AD_TagType_ID));
	}

	/** Get Tag Type.
		@return Tag Type
	  */
	public int getAD_TagType_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_AD_TagType_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

...
/** Generated Interface for AD_UserViewAccess
 *  @author Adempiere (generated) 
 *  @version Release 3.9.4
 */
public interface I_AD_UserViewAccess 
{

    /** TableName=AD_UserViewAccess */
    public static final String Table_Name = "AD_UserViewAccess";
    ...
    public static final String COLUMNNAME_AccessType = "AccessType";
    ...
    /** Column name AD_UserViewAccess_ID */
    public static final String COLUMNNAME_AD_UserViewAccess_ID = "AD_UserViewAccess_ID";
    ...
    /** Column name AD_UserView_ID */
    public static final String COLUMNNAME_AD_UserView_ID = "AD_UserView_ID";

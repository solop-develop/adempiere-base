 ...
 */
public abstract class QuoteCopyAndApproveAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "QuoteCopyAndApprove";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "Quote Convert and Approve Project";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54898;
